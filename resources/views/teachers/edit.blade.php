                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        <label for="teacher_id"
                            class="block text-sm font-medium text-gray-700 mb-2">{{ __('all.teacher_id') }} <span
                    ...
                    <div>
                        <label for="name"
                            class="block text-sm font-medium text-gray-700 mb-2">{{ __('all.teacher_name') }} <span
                                class="text-red-500">*</span></label>
                    ...
                    <!-- Subject -->
                    <div>
                        <label for="subject" class="block text-sm font-medium text-gray-700 mb-2">{{ __('all.subject') }}
