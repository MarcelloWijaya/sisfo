...
@section('title', __('all.edit_branch'))
@section('header', __('all.edit_branch'))
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                            ...
                            placeholder="Jl. Contoh No. 123, Kota">{{ old('address', $branch->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
